...
open class TreiberStackWithElimination<E> : Stack<E> {
    ...
    protected open fun tryPushElimination(element: E): Boolean {
        ...
        val prevValue = eliminationArray.getAndSet(index, CELL_STATE_EMPTY)
        return prevValue == CELL_STATE_RETRIEVED
    }
    ...
    private fun tryPopElimination(): E? {
        ...
        return when {
            element == CELL_STATE_EMPTY || element == CELL_STATE_RETRIEVED -> null
            eliminationArray.compareAndSet(index, element, CELL_STATE_RETRIEVED) -> element as E?
            else -> null
        }
    }
